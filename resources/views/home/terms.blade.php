...
<div class="container-fluid p-0">
        ...
        <div class="wrapper container-fluid">
            <div class="row justify-content-center">
                <div style="text-align: justify;" class="smoler col col-sm-8">
                    <br><h1 class="bigg text-center">Terms of Use</h1>
                    ...
                    <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Champion.GG, San Pedro, Laguna.</p>
                    </li>
                    <li>
                    ...
                    <li>
                    <p><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a class="lenk" href="https://www.privacypolicies.com/terms-conditions-generator/" target="_blank">Terms and Conditions Generator</a>.</p>
                    </li>
                    <li>
                    <p><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>
                    </li>
                    <li>
                    <p><strong>Website</strong> refers to Champion.GG, accessible from <a class="lenk" href="http://polancoschampiongg.lovestoblog.com" rel="external nofollow noopener" target="_blank">http://polancoschampiongg.lovestoblog.com</a></p>
                    </li>
                    <li>
                    <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
                    </li>
                    </ul><br>
                    <h1 class="text-center">Acknowledgment</h1>
                    ...
                    <h1 class="text-center">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
                    ...
                    <h1 class="text-center">Governing Law</h1>
                    ...
                    <h1 class="text-center">Disputes Resolution</h1>
                    ...
                    <h1 class="text-center">For European Union (EU) Users</h1>
                    ...
                    <h1 class="text-center">United States Legal Compliance</h1>
                    <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p><br>
                    <h1 class="text-center">Severability and Waiver</h1>
                    <h2>Severability</h2>
                    ...
                    <h1 class="text-center">Translation Interpretation</h1>
                    <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
                    You agree that the original English text shall prevail in the case of a dispute.</p><br>
                    <h1 class="text-center">Changes to These Terms and Conditions</h1>
                    ...
                    <ul>
                    <li>By email: shisosgun@yahoo.com</li>
                    </ul>
            </div>
        </div>
    </div>    
